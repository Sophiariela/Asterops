...
interface DeviceFrameProps {
  device: CaseStudyMockup["device"];
  image: string;
  /** Used to build the image alt text — e.g. "Storefront on desktop". */
  alt: string;
  className?: string;
  priority?: boolean;
}

/** Renders a screenshot inside a neutral device chrome, used by the case study gallery. */
export function DeviceFrame({ device, image, alt, className, priority }: DeviceFrameProps) {
